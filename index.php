...
<html lang="en">
   ...
   <body>
      ...
      <video autoplay loop muted>
          <source src="https://res.cloudinary.com/dfmg1mwcf/video/upload/v1750776961/apbmczclzugbmthj9ucb.mp4" type="video/mp4">
         ...
         <nav class="navbar navbar-expand-lg navbar-style fixed-top" id="navbar-style1">
            <div class="container-fluid pt-0 mt-0">
               ...
               <img src="https://res.cloudinary.com/dfmg1mwcf/image/upload/v1750777283/dis-india-removebg-preview_1_cm8uv0.png" style="height:100px; width: 100px; margin: 0%;" alt="">
               </a>
               <a class="navbar-brand d-none d-md-block" id="navbar-head" href="#">
               <img src="https://res.cloudinary.com/dfmg1mwcf/image/upload/v1750777283/dis-india-removebg-preview_1_cm8uv0.png" style="height:80px; width: 80px; margin-left: 380px; padding: 0px;" alt="">
               </a>
               <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
               <img src="https://res.cloudinary.com/dfmg1mwcf/image/upload/v1750777417/download-removebg-preview_vhb1l9.png" id="hamburger" alt="">
               </button>
               <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav ml-auto" id="navbar-id">
                     ...
                     <a class="nav-link " id="opt5"  onclick="log()">Login</a>
                  </div>
               </div>
            </div>
         </nav>
               ...
               <div class="row">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div class="places-card  d-flex flex-column justify-content-end align-items-center" onclick="displayMunnar()"
                        style="background-image: url('https://i.im.ge/2025/04/02/pt6K4C.munnar.jpeg'); background-size: cover;">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div onclick="displaykashmir()" class="places-card  d-flex flex-column justify-content-end align-items-center" 
                        style="background-image: url('https://i.im.ge/2025/04/02/pt6Z34.manali.jpeg'); background-size: cover;">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3  d-flex flex-column align-items-center">
                     <div onclick="displayAlappuzha()" class="places-card d-flex flex-column justify-content-end align-items-center" 
                        style="background-image: url('https://i.im.ge/2025/04/02/ptNwHp.wmremove-transformed.jpeg')
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div  class="places-card  d-flex flex-column justify-content-end align-items-center"   onclick="displayAgra()"
                        style="background-image: url('https://i.im.ge/2025/04/02/ptNhXM.taj1.jpeg'); background-size: cover; ">
                        <div class="places-card-text">
                           <h4 align="center">
                              <a href="" style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: whitesmoke ; ">
                              Arga
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div  class="places-card d-flex flex-column justify-content-end align-items-center"  onclick="displayGoa()"
                        style="background-image: url('https://i.im.ge/2025/04/02/pt6xt9.goa2.jpeg'); background-size: cover; ">
                        <div class="places-card-text">
                           <h4 align="center">
                              <a href="" style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: whitesmoke ; ">
                              Goa
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div onclick="displayJaipur()" class="places-card 3 d-flex flex-column justify-content-end align-items-center" 
                        style="background-image: url('https://i.im.ge/2025/04/02/pt6WUD.jaipur.jpeg')
                        ; background-size: cover; ">
                        <div class="places-card-text">
                           <h4 align="center">
                              <a href="" style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: whitesmoke ; ">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div class="">
                        <div  class="places-card d-flex flex-column justify-content-end align-items-center " onclick="displayOoty()"
                           style="background-image: url('https://i.im.ge/2025/04/02/pt6BUW.ooty.jpeg')
                           ; background-size: cover; ">
                           <div class="places-card-text">
                              <h4 align="center">
                                 <a href="" style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: whitesmoke ; ">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex flex-column align-items-center">
                     <div onclick="displayBangolore()" class="places-card d-flex flex-column justify-content-end align-items-center" 
                        style="background-image: url('https://i.im.ge/2025/04/02/ptPh6G.banglore.jpeg'); background-size: cover;">
                        <div class="places-card-text">
                           <h4 align="center">
                              <a href="" style="font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: whitesmoke ; ">
                              Bangaluru
               ...
               <div class="card-container">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card" onclick="window.location.href='booking.html';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6fsq.munnar1.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6EqK.goa1.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Goa Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/ptN0bD.taj-mahal-866692-1280.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Agra Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6Z34.manali.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Manali Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6WUD.jaipur.jpeg"  alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Jaipur Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6zzP.munnar3jpg.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Ooty Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/pt6pO1.mysore.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Mysore Package
                     ...
                     <div class="swiper-slide" style="width:300px;">
                        <div class="offer-card"  onclick="window.location.href='booking.php';">
                           <div>
                              <img class="card-img" src="https://i.im.ge/2025/04/02/ptPh6G.banglore.jpeg"   alt="">
                           </div>
                           <div class="card-text">
                              <h4 style="font-size: 18px; font-weight: bold;">
                                 Banglore Package
